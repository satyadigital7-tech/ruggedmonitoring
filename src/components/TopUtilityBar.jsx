...
export default function TopUtilityBar() {
  ...
  return (
    <div className="bg-white border-b border-slate-200/70 text-xs py-2 px-4 text-slate-700 select-none relative z-50">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-center sm:justify-end items-center gap-y-1.5 gap-x-4 sm:space-x-6">
        ...
        {/* Redesigned Language Dropdown Pill */}
        <div className="relative" ref={dropdownRef}>
          ...
          {isLangOpen && (
            <div className="absolute right-0 top-full mt-1.5 w-48 bg-white/95 backdrop-blur-md rounded-xl shadow-2xl border border-slate-200 p-1.5 z-50 animate-fadeIn">
              <div className="px-2 py-1 text-[10px] font-mono text-slate-400 font-bold uppercase border-b border-slate-100 mb-1 flex items-center justify-between">
                ...
                {languages.map((l) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && <Check className="w-3.5 h-3.5 text-[#005288]" />}
                    </button>
                  );
                })}
              </div>
